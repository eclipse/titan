...
/*
XXX Source of conflicts (72 S/R):
...
/*| SuperKeyword '.' IDentifier optExtendedFieldReference
  {
    $$.is_ref = true;
    $$.ref = new Ttcn::Reference(NULL, $3, Ref_simple::REF_SUPER);
    for (size_t i = 0; i < $4.nElements; i++) {
      $$.ref->add($4.elements[i]);
    }
    Free($4.elements);
...
/*| SuperKeyword
  {
    $$.is_ref = true;
    $$.ref = new Ttcn::Reference(Ref_simple::REF_SUPER);
    $$.ref->set_location(infile, @$);
  }*/
;
