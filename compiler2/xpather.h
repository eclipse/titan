 ...
 * @param legacy_codec_handling legacyCodecHandling (compiler option '-e')
...
tpd_result process_tpd(const char **p_tpd_name, const char *actcfg,
  ...
  boolean *disable_predef_exp_folder, boolean* legacy_codec_handling, struct string_list* solspeclibs, struct string_list* sol8speclibs,
