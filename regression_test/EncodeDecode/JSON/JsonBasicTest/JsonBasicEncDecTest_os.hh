...
#ifndef JsonBasicEncDecTest__os_HH
#define JsonBasicEncDecTest__os_HH
...
#undef JsonBasicEncDecTest__os_HH
#endif
...
class RoU;
class RoU_template;
typedef PreGenRecordOf::PREGEN__RECORD__OF__OCTETSTRING RoOS;
typedef PreGenRecordOf::PREGEN__RECORD__OF__OCTETSTRING_template RoOS_template;
class anytype;
...
public:
enum union_selection_type { UNBOUND_VALUE = 0, ALT_I__json = 1, ALT_E__json = 2 };
private:
union_selection_type union_selection;
union {
INTEGER *field_I__json;
JsonBasicTypes::E__json *field_E__json;
};
...
INTEGER& AT_I__json();
const INTEGER& AT_I__json() const;
JsonBasicTypes::E__json& AT_E__json();
const JsonBasicTypes::E__json& AT_E__json() const;
...
union {
INTEGER_template *field_I__json;
JsonBasicTypes::E__json_template *field_E__json;
};
} single_value;
struct {
unsigned int n_values;
...
void set_type(template_sel template_type, unsigned int list_length);
INTEGER_template& AT_I__json();
const INTEGER_template& AT_I__json() const;
JsonBasicTypes::E__json_template& AT_E__json();
const JsonBasicTypes::E__json_template& AT_E__json() const;
...
extern void f__compare__octetstring(const OCTETSTRING& pl__val, const OCTETSTRING& pl__expected);
extern verdicttype testcase_tc__jsonBasic__encdec__os__integer(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__float(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__enum(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__bitstring(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__charstring(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__hexstring(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__octetstring(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__ucharstring(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__verdict(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__record(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__set(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__AI3(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__roi1(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__roi2(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__roi3(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__soi(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__union__const(boolean has_timer, double timer_value);
...
extern void RoOS_0_encoder(const OCTETSTRING& input_value, OCTETSTRING& output_stream, const UNIVERSAL_CHARSTRING& coding_name);
extern INTEGER RoOS_0_decoder(OCTETSTRING& input_stream, OCTETSTRING& output_value, const UNIVERSAL_CHARSTRING& coding_name);
extern void RoOS_encoder(const RoOS& input_value, OCTETSTRING& output_stream, const UNIVERSAL_CHARSTRING& coding_name);
extern INTEGER RoOS_decoder(OCTETSTRING& input_stream, RoOS& output_value, const UNIVERSAL_CHARSTRING& coding_name);
extern verdicttype testcase_tc__jsonBasic__encdec__os__union(boolean has_timer, double timer_value);
extern verdicttype testcase_tc__jsonBasic__encdec__os__anytype__i(boolean has_timer, double timer_value);
...
extern const TTCN_JSONdescriptor_t RoOS_json_;
extern const TTCN_Typedescriptor_t RoOS_descr_;
extern const XERdescriptor_t RoOS_0_xer_;
extern const TTCN_OERdescriptor_t RoOS_0_oer_;
extern const TTCN_Typedescriptor_t RoOS_0_descr_;
extern UNIVERSAL_CHARSTRING RoOS_0_default_coding;
extern UNIVERSAL_CHARSTRING RoOS_default_coding;
extern const TTCN_JSONdescriptor_t anytype_json_;
extern const TTCN_Typedescriptor_t anytype_descr_;
extern const XERdescriptor_t anytype_I__json_xer_;
extern const TTCN_Typedescriptor_t anytype_I__json_descr_;
extern UNIVERSAL_CHARSTRING anytype_I__json_default_coding;
extern const TTCN_Typedescriptor_t anytype_E__json_descr_;
extern UNIVERSAL_CHARSTRING anytype_E__json_default_coding;
